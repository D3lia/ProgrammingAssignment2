## In this assignment we will program a way to find the inverse of a matrix,
# by caching the result within a lexical scope of a function:
#"makeCacheMatrix" and "cacheSolve". 
#Caching is using memory to avoid excess computation.
